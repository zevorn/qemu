...
static void test_pu_compute_fetchif_uses_if_staging(void)
{
    QTestState *qts = k230_kpu_init();
    const uint8_t input[] = {
        5, 7,
...
int main(int argc, char *argv[])
{
    ...
    qtest_add_func("/k230-kpu/pu-compute-fetchif-uses-if-staging",
                   test_pu_compute_fetchif_uses_if_staging);

...
/*
 * SMCCC v1.1 discovery call. Linux asks for this via PSCI_FEATURES
 * before enabling arm_smccc_1_1_invoke() users such as SCMI-over-SMC.
 */
#define QEMU_SMCCC_VERSION_FUNC_ID 0x80000000
#define QEMU_SMCCC_VERSION_1_1     0x10001

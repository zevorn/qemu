...
static void virt_machine_init(MachineState *machine)
{
     ...
     * The DM is a non-ISA peripheral (Spec Chapter 3) that exists
     * independently of the Sdext ISA extension on the CPU side.
     * When Sdext is disabled, the DM is present but harts will not
     * respond to halt requests -- this matches real hardware behavior.
     */

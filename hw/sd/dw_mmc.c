    ...
    while (processed++ < DW_MMC_IDMAC_MAX_DESCS) {
        ...
        if (buf_size > 0 && des2 != 0) {
            if (is_write) {
                ...
                cpu_physical_memory_read(des2, buf, buf_size);
                ...
                cpu_physical_memory_write(des2, buf, buf_size);
            }
...
static uint64_t dw_mmc_read(void *opaque, hwaddr offset, unsigned size)
{
    ...
    case 0x000: /* CTRL */
        r = s->ctrl;
        break;
    case 0x004: r = s->pwren; break;
    case 0x008: r = s->clkdiv; break;
    case 0x00c: r = s->clksrc; break;
    case 0x010: r = s->clkena; break;
    case 0x014: r = s->tmout; break;
    case 0x018: r = s->ctype; break;
    case 0x01c: r = s->blksiz; break;
    case 0x020: r = s->bytcnt; break;
    case 0x024: r = s->intmask; break;
    case 0x028: r = s->cmdarg; break;
    case 0x02c: r = s->cmd; break;
    case 0x030: r = s->resp[0]; break;
    case 0x034: r = s->resp[1]; break;
    case 0x038: r = s->resp[2]; break;
    case 0x03c: r = s->resp[3]; break;
    case 0x040: /* MINTSTS = RINTSTS & INTMASK */
        r = s->rintsts & s->intmask;
        break;
    case 0x044: r = s->rintsts; break;
    ...
    case 0x054: /* WRTPRT */
        ...
        break;
    case 0x058: r = 0; break;          /* GPIO */
    case 0x05c: r = 0; break;          /* TCBCNT */
    case 0x060: r = 0; break;          /* TBBCNT */
    case 0x064: r = s->debnce; break;
    case 0x068: r = s->usrid; break;
    case 0x06c: r = s->verid; break;
    case 0x070: r = s->hcon; break;
    case 0x074: r = s->uhs_reg; break;
    case 0x078: r = s->rst_n; break;
    case 0x080: r = s->bmod; break;
    case 0x084: r = 0; break;          /* PLDMND - WO */
    case 0x088: r = s->dbaddr; break;
    case 0x08c: r = s->idsts; break;
    case 0x090: r = s->idinten; break;
    case 0x094: r = 0; break;          /* DSCADDR */
    case 0x098: r = 0; break;          /* BUFADDR */
    ...
    case 0x200: /* Legacy FIFO data port used by U-Boot dw_mmc. */
        ...
        break;
    case 0x108: r = 0; break;          /* UHS_REG_EXT */
    case 0x10c: r = 0; break;          /* DDR_REG */
    case 0x110: r = s->enable_shift; break;
    default:
                         ...
                         unsigned size)
{
    ...
    case 0x000: /* CTRL */
        ...
        dw_mmc_update_irq(s);
        break;
    case 0x004: s->pwren = v; break;
    case 0x008: s->clkdiv = v; break;
    case 0x00c:
        /* CLKSRC writes are ignored except 0 (single clock source). */
        s->clksrc = 0;
        break;
    case 0x010: s->clkena = v; break;
    case 0x014: s->tmout = v; break;
    case 0x018: s->ctype = v; break;
    case 0x01c: s->blksiz = v; break;
    case 0x020: s->bytcnt = v; break;
    case 0x024: /* INTMASK */
        s->intmask = v;
        dw_mmc_update_irq(s);
        break;
    case 0x028: s->cmdarg = v; break;
    case 0x02c: /* CMD */
        s->cmd = v;
        if (v & CMD_START) {
    ...
    case 0x050: /* CDETECT - RO. */
        break;
    case 0x054: break;
    case 0x058: break;                 /* GPIO - RAZ/WI */
    case 0x05c: case 0x060: break;     /* TCBCNT/TBBCNT RO */
    case 0x064: s->debnce = v; break;
    case 0x068: s->usrid = v; break;
    case 0x06c: break;                 /* VERID RO */
    case 0x070: break;                 /* HCON RO */
    case 0x074: s->uhs_reg = v; break;
    case 0x078: s->rst_n = v; break;
    ...
    case 0x084: /* PLDMND - write 1 kicks IDMAC. */
        ...
        break;
    case 0x088: s->dbaddr = v; break;
    case 0x08c: /* IDSTS - W1C. */
        s->idsts &= ~v;
        dw_mmc_update_irq(s);
        break;
    case 0x090: s->idinten = v; break;
    case 0x094: case 0x098: break;     /* DSCADDR/BUFADDR RO */
    case 0x100: /* CDTHRCTL or FIFO data port for VERID >= 0x240a. */
    ...
    case 0x200: /* Legacy FIFO data port used by U-Boot dw_mmc. */
        ...
        break;
    case 0x108: case 0x10c: break;     /* UHS_REG_EXT / DDR_REG */
    case 0x110: s->enable_shift = v; break;
    default:
        if (offset >= 0x114 && offset < DW_MMC_CORE_MMIO_SIZE) {
            break;
        }
